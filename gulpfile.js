...
/*-- Watch --*/
function watchFiles() {
    gulp.watch([src.html, src.partials], gulp.series(['style', 'html'], reload));
    ...
    // gulp.watch(src.scss, gulp.series(['bootstrap', 'style', 'stylePages','new']));
    gulp.watch(src.scss, gulp.series(['html','style'],reload));
    
}

/*-- All Default Task --*/
// gulp.task('defaultTask', gulp.series('html', 'css', 'fonts', 'js', 'php', 'scss', 'bootstrap', 'style', 'stylePages', 'images', 'svgGif','new'));
